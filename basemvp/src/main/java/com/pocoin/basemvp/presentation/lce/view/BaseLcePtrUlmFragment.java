...
import com.pocoin.basemvp.presentation.lce.RefreshHeader;
...
public abstract class BaseLcePtrUlmFragment<M, V extends LcePtrUlmView<M>, P extends LcePresenter<V>> extends BaseFragment<V, P>
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lcePtrUlmViewPlugin.setupBaseView(inflater.inflate(R.layout.fragment_lce_base, container, false));
        return lcePtrUlmViewPlugin.getBaseView();
    }

    @Override
    public void onDestroyView() {
        lcePtrUlmViewPlugin = null;
        super.onDestroyView();
