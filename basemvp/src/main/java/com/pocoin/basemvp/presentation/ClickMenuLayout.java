...
public class ClickMenuLayout extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static ClickMenuLayout mViewCache;
    ...
    public ClickMenuLayout(Context context) {
        this(context, null);
    }

    public ClickMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClickMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public ClickMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public ClickMenuLayout setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static ClickMenuLayout getViewCache() {
        return mViewCache;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //左滑右滑的开关,默认左滑打开菜单
        isLeftSwipe = true;
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ClickMenuLayout, defStyleAttr, 0);
        int count = ta.getIndexCount();
        for (int i = 0; i < count; i++) {
            int attr = ta.getIndex(i);
            //如果引用成AndroidLib 资源都不是常量，无法使用switch case
            if (attr == R.styleable.ClickMenuLayout_swipeEnable) {
                isSwipeEnable = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.ClickMenuLayout_ios) {
                isIos = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.ClickMenuLayout_leftSwipe) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (child.getVisibility() != GONE) {
                ...
                if (lp.height == LayoutParams.MATCH_PARENT) {
                    ...
                    // this may not be right for something like wrapping text?
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = ClickMenuLayout.this;
