...
public class DownloadUtil {
    ...
    public static DownloadInfo downloadInfoSync(OkHttpClient httpClient, DownloadInfo downloadInfo, boolean isResume) throws Throwable{
    ...
    public static Observable<DownloadInfo> downloadFile(final OkHttpClient httpClient, final DownloadInfo downloadInfo, final boolean isResume) {
        Observable.OnSubscribe<DownloadInfo> subscribe = new Observable.OnSubscribe<DownloadInfo>() {
            @Override
